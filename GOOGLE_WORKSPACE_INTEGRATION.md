...
- Approved absences create/update an all-day event in the configured Google Calendar.
- Rejected/cancelled absences delete the linked Google Calendar event when one exists.
- Task creation sends an email to the assignee and creates/updates a due-date calendar event.
